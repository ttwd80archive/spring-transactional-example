 ...
 *
 */
public class PropagationStartsNewTransactionGroupWithoutCatchITCase extends
	...
	public void testRequiredInvalid2() {
		...
		assertThat(attempt, equalTo(Arrays.asList("1", "2")));
	...
	protected void insert(final int propagationBehavior, final String[][] values) {
		try {
			simpleService.insertMultipleTwoLayerWithoutCatch(
					propagationBehavior, values[0], values[1], values[2],
					attempt);
